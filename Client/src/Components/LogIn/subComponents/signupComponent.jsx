...
import { signUpService } from "../../../context/auth/AuthenticationApiService";
...
const SignupComponent = (props) => {
    ...
    return (
        ...
        <Form className="form-container form-style">
            ...
            <div className="join-text"><b className="join-link" onClick={()=>{props.changeComp(<LoginUserPassword changeComp={props.changeComp} closeForm={props.closeForm}/>, 'LoginUserPassword')}}>Sign in</b> using your OS Science account.</div>
